...
png(paste(anno,'1.2_0.8_5','_22_chr_large.png', sep=""), height = 15, width = 11,units='in',res=1600)
...
kpPlotRegions(kp1,annot.range,r0 = -0.17, r1=0.17,col=transparent('#D87019', amount=0.90),avoid.overlapping=FALSE,data.panel=2)
dev.off()
...
kpPlotRegions(kp2,annot.range,r0 = -0.17, r1=0.17,col=transparent('#D87019', amount=0.90),avoid.overlapping=FALSE,data.panel=2)
